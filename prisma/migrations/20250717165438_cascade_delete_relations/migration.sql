...
INSERT INTO "new_Task" ("createdAt", "description", "dueDate", "finishedAt", "id", "isDone", "projectId", "title", "updatedAt", "urgency", "userId") SELECT "createdAt", "description", "dueDate", "finishedAt", "id", "isDone", "projectId", "title", "updatedAt", "urgency", "userId" FROM "Task";
DROP TABLE "Task";
